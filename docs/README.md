...
|---|---|---|
| **`CAMPUSGRID_AI_SIMPLIFIED_SRS_AND_SYSTEM_GUIDE.md`** | The working system guide, in seven focused views: the problem, the architecture, the four agents, the tech stack, the offline pipelines, the codebase layout, and team delegation. | You want to understand how the system works. **Start here.** |
